defmodule OnlineShopWeb.ItemControllerTest do
  use OnlineShopWeb.ConnCase

  alias OnlineShop.Shop

  @create_attrs %{amount: "some amount", name: "some name", vendor_code: "7488a646-e31f-11e4-aace-600308960662"}
  ...
  def fixture(:item) do
    {:ok, item} = Shop.create_item(@create_attrs)
    item
  end
